...
app = Flask('app')
# docker run --name some-postgres -e POSTGRES_PASSWORD=password -e POSTGRES_USER=user -e POSTGRES_DB=ps_db -d postgres
app.config["SQLALCHEMY_DATABASE_URI"] = 'postgresql://user:password@172.17.0.2/ps_db' # подключение к postgres
